...
if [ -n "$plugin_dir" ] && [ -f "$plugin_dir/.mcp.json" ]; then
    ...
    if curl -fsSL "$PLUGIN_URL" -o "$PLUGIN_DEST" 2>/dev/null; then
        ...
        echo ""
        echo "  ┌─────────────────────────────────────────────────┐"
        echo "  │  STEP 1: Install the plugin (do this now)       │"
        echo "  └─────────────────────────────────────────────────┘"
        echo ""
        ...
        echo ""
        echo "  ┌─────────────────────────────────────────────────┐"
        echo "  │  STEP 2: Come back here and finish setup        │"
        echo "  └─────────────────────────────────────────────────┘"
        echo ""
        echo "  Once the plugin is installed, run this same command again:"
        echo ""
        echo "  curl -fsSL https://raw.githubusercontent.com/duyemura/pushpress-claude-mcp-installer/main/install.sh | bash"
        echo ""
        echo "  It will detect the plugin and skip straight to connecting"
        echo "  your tools (GymHappy, Metabase, etc)."
        echo ""
